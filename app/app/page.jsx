      ...
      <header className="bg-blue-700 text-white">
        <div className="max-w-6xl mx-auto px-6 py-5 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            {/* SB Logo */}
            <div className="w-14 h-14 bg-white text-blue-700 rounded-xl flex items-center justify-center font-bold">
              SB
            </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <p className="text-slate-600 leading-7 mb-6">
            ...
            and commercial sectors. Our services include linen processing, uniform rental,
            and professional maintenance designed for operational reliability and hygiene compliance.
          </p>
        ...
        <div className="bg-slate-50 p-8 rounded-2xl border">
          ...
          <ul className="space-y-2 text-slate-700">
            ...
            <li>🏭 Factories & Industrial Operations</li>
      ...
      <section id="contact" className="bg-blue-700 text-white py-20 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-blue-100 mb-8">
            Speak with us for reliable industrial laundry solutions tailored to your operations.
          </p>
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            ...
            <a
              href="https://wa.me/60129293513"
              className="bg-white text-blue-700 px-6 py-3 rounded-xl font-medium"
            >
              WhatsApp 1
            </a>

            <a
              href="https://wa.me/60143885295"
              className="bg-white text-blue-700 px-6 py-3 rounded-xl font-medium"
            >
              WhatsApp 2
            </a>
